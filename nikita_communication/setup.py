...
setup(
    ...
    data_files=[
        ('lib/' + package_name, ['nikita_communication/chatbot.py', 'nikita_communication/music_player.py', 'nikita_communication/stt_keyword.py', 'nikita_communication/stt_offline.py', 'nikita_communication/stt_online.py', 'nikita_communication/tts.py']),
