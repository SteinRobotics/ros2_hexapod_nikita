...
class CCommunication : public IHandler {
   public:
    ...
    void onCommunicationStatus(const nikita_interfaces::msg::CommunicationStatus& msg);
   ...
   private:
    ...
    rclcpp::Subscription<nikita_interfaces::msg::CommunicationStatus>::SharedPtr m_subStatus;
