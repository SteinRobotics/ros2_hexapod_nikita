"""Launch head-sweep scan and reactive navigation for the Nikita hexapod."""
...
def generate_launch_description():
    pkg_nav = get_package_share_directory('nikita_navigation')
    config = os.path.join(pkg_nav, 'config', 'navigation.yaml')
