 ...
 *              /single_servo_request (nikita_interfaces/ServoAngle)
 ******************************************************************************/
...
class NodeHeadScan : public rclcpp::Node {
   public:
    NodeHeadScan() : Node("node_head_scan") {
        ...
        servo_pub_ = create_publisher<nikita_interfaces::msg::ServoAngle>("single_servo_request", 10);
   ...
   private:
    void sweepTick() {
        ...
        nikita_interfaces::msg::ServoAngle servo_msg;
    ...
    rclcpp::Publisher<nikita_interfaces::msg::ServoAngle>::SharedPtr servo_pub_;
