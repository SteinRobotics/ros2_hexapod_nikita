...
#include "bus_servo_protocol.hpp"
...
BusServoProtocol::BusServoProtocol(std::shared_ptr<rclcpp::Node> node, std::string deviceName)
    : node_(node), deviceName_(deviceName) {
}

bool BusServoProtocol::triggerConnection() {
    isConnected_ = false;
...
bool BusServoProtocol::isConnected() {
    return isConnected_;
}

void BusServoProtocol::closeConnection() {
    close(device_);
}

bool BusServoProtocol::writeToServo(uint8_t buf[], int numBytes) {
...
bool BusServoProtocol::readCMD(uint8_t ID, uint8_t CMD_opcode, uint8_t RX_buf_size, uint8_t* RX_buf) {
...
uint8_t BusServoProtocol::checksum(uint8_t buf[]) {
    uint8_t i;
    uint16_t chksum = 0;
    for (i = 2; i < buf[3] + 2; i++) {
        chksum += buf[i];
...
bool BusServoProtocol::getServoID(uint8_t ID, uint8_t& answer) {
...
bool BusServoProtocol::setServoID(uint8_t ID, uint8_t newID) {
...
bool BusServoProtocol::setPosition(uint8_t ID, uint16_t pos, uint16_t time) {
...
bool BusServoProtocol::setRegPos(uint8_t ID, uint16_t pos, uint16_t time) {
...
bool BusServoProtocol::actionStart(uint8_t ID) {
...
bool BusServoProtocol::moveStop(uint8_t ID) {
...
bool BusServoProtocol::getPositionOffset(uint8_t ID, int8_t& deviation) {
...
bool BusServoProtocol::setPositionOffset(uint8_t ID, int8_t deviation) {
...
bool BusServoProtocol::savePositionOffset(uint8_t ID) {
...
bool BusServoProtocol::getPositionLimits(uint8_t ID, uint16_t& min_position, uint16_t& max_position) {
...
bool BusServoProtocol::setPositionLimits(uint8_t ID, uint16_t min_position, uint16_t max_position) {
...
bool BusServoProtocol::flashLedErrCode(uint8_t ID, uint8_t code) {
...
bool BusServoProtocol::getPosition(uint8_t ID, int16_t& pos) {
...
bool BusServoProtocol::getVoltage(uint8_t ID, uint16_t& vin) {
...
bool BusServoProtocol::getVoltageLimits(uint8_t ID, uint16_t& min_voltage, uint16_t& max_voltage) {
...
bool BusServoProtocol::setVoltageLimits(uint8_t ID, uint16_t min_voltage, uint16_t max_voltage) {
...
bool BusServoProtocol::getTemperature(uint8_t ID, uint8_t& temp) {
...
bool BusServoProtocol::getMaxTemperatureLimit(uint8_t ID, uint8_t& max_temperature) {
...
bool BusServoProtocol::setMaxTemperatureLimit(uint8_t ID, uint8_t max_temperature) {
...
bool BusServoProtocol::getLedErrcode(uint8_t ID, uint8_t& lederrcode) {
...
bool BusServoProtocol::getMode(uint8_t ID, uint8_t& mode) {
...
bool BusServoProtocol::getMotorSpeed([[maybe_unused]] uint8_t ID, [[maybe_unused]] int16_t& speed) {
...
bool BusServoProtocol::setServoMode(uint8_t ID) {
...
bool BusServoProtocol::setMotorMode(uint8_t ID, int16_t speed) {
    uint8_t buf[s_SERVO_MODE_WRITE + 3];
...
bool BusServoProtocol::setTorque(uint8_t ID, bool active) {
...
bool BusServoProtocol::isLedOn(uint8_t ID) {
...
bool BusServoProtocol::setLed(uint8_t ID, bool on) {
